...
def train(mode,
    ...
    if verbose:
        valid_images, valid_labels, _ = reconstruct_from_record(data.get_test_tfrecord()) # noqa
        ...
        plotconfusion(valid_labels, valid_pred, name + ".png", int2command, classes=["left", "right", "up"], bound=10000) # noqa
    if move:
